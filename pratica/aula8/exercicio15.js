...
function relatorioVendas(vendas) {
    ...
    vendasLoja.forEach(function(venda) {
        const totalVenda = totalProduto(venda);
        totalGeral += totalVenda;
        console.log(`${venda.produto} vendeu ${totalVenda.toFixed(2)}`);
    })


    console.log(`Total vendido na loja: R$${totalGeral.toFixed(2)}`);

}

console.log(relatorioVendas(vendasLoja))
